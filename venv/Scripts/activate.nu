...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\VS Code\Python Notes from speech\NotesFromSpeech\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\VS Code\Python Notes from speech\NotesFromSpeech\venv\Scripts\deactivate.nu'
